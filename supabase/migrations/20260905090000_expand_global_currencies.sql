-- Expand Mushavo Budget from the original regional catalogue to current global currencies.
-- Safe to rerun: existing financial records and workspace currency selections are preserved.
